...
export class CustomerControllerBase {
  ...
  async findCustJobs(
    ...
    const results = await this.service.findCustJobs(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/custJobs")
  @nestAccessControl.UseRoles({
    resource: "Customer",
    action: "update",
    possession: "any",
  })
  async connectCustJobs(
    @common.Param() params: CustomerWhereUniqueInput,
  ...
  @common.Patch("/:id/custJobs")
  @nestAccessControl.UseRoles({
    resource: "Customer",
    action: "update",
    possession: "any",
  })
  async updateCustJobs(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: JobWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/custJobs")
  @nestAccessControl.UseRoles({
    resource: "Customer",
    action: "update",
    possession: "any",
  })
  async disconnectCustJobs(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: JobWhereUniqueInput[]
  ): Promise<void> {
    const data = {
