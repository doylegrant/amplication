...
export class JobResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [User], { name: "techs" })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async findTechs(
    ...
    const results = await this.service.findTechs(parent.id, args);
  ...
  async getPm(@graphql.Parent() parent: Job): Promise<User | null> {
    const result = await this.service.getPm(parent.id);
